 ...
 <div class="parentCourse_div" id="ParentCourse_div" >
                <div class="col-12 text-center">
                    <h3 class="mb-4" style="color:white" > Faculty Webinar</h3>
                </div>
                <form id="myForm"   >
                    <table>
                        <tr>
        ...
        <div class="subcourse_div" id="subCorse_div"> 
              <div class="col-12 text-center">
                <h3 class="mb-4"  style="color:white">Students Webinar </h3>
              </div>
              ...
              <div class="col-12 text-center">
                <h3 class="mb-4"  style="color:white">Upcoming Courses  </h3>
              </div>
              <form id="myForm2" action="adminPanelAction.php" method="post">
                    <table>
                                <tr>
