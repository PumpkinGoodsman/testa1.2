<style>
    .pricing-thumb {
        border: 5px dotted #269524;
        background-color: #D3D3D3; /* Background color for pricing thumbs */
        color: #333333; /* Font color for pricing thumbs */
    }

    .pricing-thumb h3 {
        color: #003366; /* Font color for pricing titles */
    }

    .pricing-section {
        background-color: #D3D3D3; /* Background color for the entire section */
        color: #FFFFFF; /* Font color for section text */
    }
</style>
...
<section class="pricing-section section-padding section-bg" id="section_5" >
    <div class="container">
        <div class="row">
            <div class="col-lg-8 col-12 mx-auto" style="margin-bottom : 10%;">
                <h2 class="text-center mb-4" style="color: #003366 ;" >Plans, you'll love</h2>
            </div>
